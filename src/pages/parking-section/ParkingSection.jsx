...
export default function ParkingSection() {
  ...
  return (
    <>
      <div className="flex justify-between items-center p-4" onClick={showModal}>
        <h1 className="text-xl font-bold">Parking Section</h1>
        <button className="bg-white text-gray-600  py-2 pl-4 pr-8 border border-gray-400 rounded flex items-center">
